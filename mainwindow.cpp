    ...
    currentLogMessageRow(NULL)
{
    ...
    QSplitter *splHorizontal = new QSplitter(ui->centralWidget);
    ui->horizontalLayout->addWidget(splHorizontal);
    splHorizontal->addWidget(ui->logsList);
    splHorizontal->addWidget(ui->logDetail);
    splHorizontal->addWidget(ui->deviceSyncWidget);
